...
public interface IRequestPipelineBehavior {
    ...
    /// <returns>A task representing the asynchronous operation, containing a result object indicating the success or failure of the process.</returns>
    ...
    /// <returns>A <see cref="ValueTask{TResult}"/> containing a <see cref="Result{TResponse}"/> which indicates the outcome of the request handling process.</returns>
