...
internal sealed record EventDispatcherOptions
{
    ...
    /// </summary>
    public DistributionMode DefaultDistributionMode { get; set; } = DistributionMode.LocalOnly;
    ...
    /// <summary>
    ///     Batch size for batched dispatch strategy.
    /// </summary>
    public int BatchSize { get; set; } = 100;

    /// <summary>
    ///     Interval for flushing batched events.
    /// </summary>
    ...
    ///     </para>
    ///     <code>
    ///     // The Mediator.Generator will generate this code for all IEvent types
