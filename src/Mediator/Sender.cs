...
internal sealed class Sender : ISender
{
        ...
        where TRequest : IRequest<TResponse>
    {
        ...
        if (handler is null) throw new MissingHandlerException(typeof(IRequestHandler<TRequest, TResponse>));
        ...
        where TResponse : notnull
    {
        ...
        if (handler is null) throw new MissingHandlerException(typeof(IMutationHandler<TMutation, TResponse>));
        ...
        where TResponse : notnull
    {
        ...
        if (handler is null) throw new MissingHandlerException(typeof(IQueryHandler<TQuery, TResponse>));
