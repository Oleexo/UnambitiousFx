...
public static class ResultPredicateExtensions
{
    ...
    /// <param name="predicate">The predicate to evaluate against the errors of the failure.</param>
    ...
    /// <summary>
    /// Verifies that a failure <see cref="Result{T1}"/> satisfies the specified predicate for the errors.
    /// </summary>
    ...
    /// <summary>
    /// Asynchronously asserts that the given <see cref="Task{TResult}"/> producing a <see cref="Result{T1}"/> is a failure and the errors satisfy the predicate.
    /// </summary>
    ...
    /// <summary>
    /// Asserts that a <see cref="ValueTask{TResult}"/> producing a <see cref="Result{T1}"/> is a failure and the errors satisfy the predicate.
    /// </summary>
    ...
    /// <summary>
    /// Asserts that the specified <see cref="Result{T1, T2}"/> is a failure and that the failure errors satisfy the predicate.
    /// </summary>
    ...
    /// <summary>
    /// Asserts that a <see cref="ValueTask{TResult}"/> producing <see cref="Result{T1, T2}"/> is a failure and the errors satisfy the predicate.
    /// </summary>
