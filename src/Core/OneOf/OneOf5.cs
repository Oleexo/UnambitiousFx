...
/// <summary>
/// Minimal discriminated union base abstraction representing a value that can be one of 5 types.
    ...
    where TFifth : notnull
{
    ...
    public abstract TOut Match<TOut>(Func<TFirst, TOut> firstFunc, Func<TSecond, TOut> secondFunc, Func<TThird, TOut> thirdFunc, Func<TFourth, TOut> fourthFunc, Func<TFifth, TOut> fifthFunc);
    ...
    public abstract void Match(Action<TFirst> firstAction, Action<TSecond> secondAction, Action<TThird> thirdAction, Action<TFourth> fourthAction, Action<TFifth> fifthAction);
    ...
    /// <param name="value">The first value</param>
    /// <returns>A OneOf instance containing the first value</returns>
    public static  implicit operator OneOf<TFirst, TSecond, TThird, TFourth, TFifth>(TFirst value) {
    ...
    /// <param name="value">The second value</param>
    /// <returns>A OneOf instance containing the second value</returns>
    public static  implicit operator OneOf<TFirst, TSecond, TThird, TFourth, TFifth>(TSecond value) {
    ...
    /// <param name="value">The third value</param>
    /// <returns>A OneOf instance containing the third value</returns>
    public static  implicit operator OneOf<TFirst, TSecond, TThird, TFourth, TFifth>(TThird value) {
    ...
    /// <param name="value">The fourth value</param>
    /// <returns>A OneOf instance containing the fourth value</returns>
    public static  implicit operator OneOf<TFirst, TSecond, TThird, TFourth, TFifth>(TFourth value) {
    ...
    /// <param name="value">The fifth value</param>
    /// <returns>A OneOf instance containing the fifth value</returns>
    public static  implicit operator OneOf<TFirst, TSecond, TThird, TFourth, TFifth>(TFifth value) {
