...
/// <summary>
///     Represents a discriminated union of four possible value types.
/// </summary>
...
internal sealed class ThirdOneOf<TFirst, TSecond, TThird, TFourth> : OneOf<TFirst, TSecond, TThird, TFourth>
    where TFirst : notnull
    where TSecond : notnull
    where TThird : notnull
    where TFourth : notnull {
