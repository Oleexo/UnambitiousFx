    ...
    where TValue2 : notnull
{
    ...
    public override bool Ok([NotNullWhen(true)] out TValue1? value1, [NotNullWhen(true)] out TValue2? value2, [NotNullWhen(false)] out Exception? error) {
        value1 = default;
        value2 = default;
        error = PrimaryException;
        return false;
    ...
    public override bool Ok([NotNullWhen(true)] out TValue1? value1, [NotNullWhen(true)] out TValue2? value2) {
        value1 = default;
        value2 = default;
        return false;
    }
