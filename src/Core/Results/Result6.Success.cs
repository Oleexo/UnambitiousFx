    ...
    where TValue6 : notnull
{
    ...
    public override void Match(Action<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6> success, Action<IEnumerable<IError>> failure) {
        success(_value1, _value2, _value3, _value4, _value5, _value6);
    }
    
    public override TOut Match<TOut>(Func<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TOut> success, Func<IEnumerable<IError>, TOut> failure) {
    ...
    public override bool TryGet([NotNullWhen(true)] out TValue1? value1, [NotNullWhen(true)] out TValue2? value2, [NotNullWhen(true)] out TValue3? value3, [NotNullWhen(true)] out TValue4? value4, [NotNullWhen(true)] out TValue5? value5, [NotNullWhen(true)] out TValue6? value6, [NotNullWhen(false)] out IEnumerable<IError>? errors) {
        value1 = _value1;
        value2 = _value2;
        value3 = _value3;
        value4 = _value4;
