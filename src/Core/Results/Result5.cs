    ...
    where TValue5 : notnull
{
    ...
    public abstract void Match(Action<TValue1, TValue2, TValue3, TValue4, TValue5> success, Action<Exception> failure);
    ...
    public abstract TOut Match<TOut>(Func<TValue1, TValue2, TValue3, TValue4, TValue5, TOut> success, Func<Exception, TOut> failure);
    ...
    public abstract bool TryGet([NotNullWhen(true)] out TValue1? value1, [NotNullWhen(true)] out TValue2? value2, [NotNullWhen(true)] out TValue3? value3, [NotNullWhen(true)] out TValue4? value4, [NotNullWhen(true)] out TValue5? value5, [NotNullWhen(false)] out Exception? error);
    ...
    /// <param name="error">The exception if failed</param>
    public abstract void Deconstruct(out bool isSuccess, out (TValue1, TValue2, TValue3, TValue4, TValue5)? value, out Exception? error);
