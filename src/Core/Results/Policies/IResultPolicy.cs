...
public interface IResultPolicy {
    ...
    ValueTask<Result> ExecuteAsync(Func<ValueTask<Result>> action,
                                   CancellationToken       cancellationToken = default);

    /// <summary>Execute a generic Result&lt;T&gt; returning operation.</summary>
    ValueTask<Result<T>> ExecuteAsync<T>(Func<ValueTask<Result<T>>> action,
                                         CancellationToken          cancellationToken = default)
        where T : notnull;
}
...
public static class ResultPolicyExtensions {
    ...
    public static ValueTask<Result> ExecuteAsync(this IResultPolicy policy,
                                                 Func<Result>       action,
    ...
    public static ValueTask<Result<T>> ExecuteAsync<T>(this IResultPolicy policy,
