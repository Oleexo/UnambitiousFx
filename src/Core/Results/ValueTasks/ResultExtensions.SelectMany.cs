...
public static partial class ResultExtensions {
    public static ValueTask<Result<TResult>> SelectMany<TValue1, TCollection, TResult>(this Result<TValue1>                          source,
                                                                                       Func<TValue1, ValueTask<Result<TCollection>>> collectionSelector,
                                                                                       Func<TValue1, TCollection, TResult>           resultSelector)
        where TValue1 : notnull
        where TCollection : notnull
        where TResult : notnull {
        return source.Match<ValueTask<Result<TResult>>>(async value1 => {
            var inner = await collectionSelector(value1);
            return inner.Map(c => resultSelector(value1, c));
        }, e => new ValueTask<Result<TResult>>(Result.Failure<TResult>(e)));
    }

    public static ValueTask<Result<TResult>> SelectMany<TValue1, TCollection, TResult>(this ValueTask<Result<TValue1>>               awaitableSource,
                                                                                       Func<TValue1, ValueTask<Result<TCollection>>> collectionSelector,
                                                                                       Func<TValue1, TCollection, TResult>           resultSelector)
        where TValue1 : notnull
        where TCollection : notnull
    ...
    public static ValueTask<Result<TResult>> SelectMany<TValue1, TValue2, TCollection, TResult>(this Result<TValue1, TValue2>                          source,
                                                                                                Func<TValue1, TValue2, ValueTask<Result<TCollection>>> collectionSelector,
    ...
    public static ValueTask<Result<TResult>> SelectMany<TValue1, TValue2, TCollection, TResult>(this ValueTask<Result<TValue1, TValue2>>               awaitableSource,
                                                                                                Func<TValue1, TValue2, ValueTask<Result<TCollection>>> collectionSelector,
                                                                                                Func<TValue1, TValue2, TCollection, TResult>           resultSelector)
        where TValue1 : notnull
        where TValue2 : notnull
    ...
    public static ValueTask<Result<TResult>> SelectMany<TValue1, TValue2, TValue3, TCollection, TResult>(this Result<TValue1, TValue2, TValue3> source,
                                                                                                         Func<TValue1, TValue2, TValue3, ValueTask<Result<TCollection>>>
                                                                                                             collectionSelector,
    ...
    public static ValueTask<Result<TResult>> SelectMany<TValue1, TValue2, TValue3, TCollection, TResult>(this ValueTask<Result<TValue1, TValue2, TValue3>> awaitableSource,
                                                                                                         Func<TValue1, TValue2, TValue3, ValueTask<Result<TCollection>>>
                                                                                                             collectionSelector,
                                                                                                         Func<TValue1, TValue2, TValue3, TCollection, TResult> resultSelector)
        where TValue1 : notnull
    ...
    public static ValueTask<Result<TResult>> SelectMany<TValue1, TValue2, TValue3, TValue4, TCollection, TResult>(this Result<TValue1, TValue2, TValue3, TValue4> source,
                                                                                                                  Func<TValue1, TValue2, TValue3, TValue4,
                                                                                                                      ValueTask<Result<TCollection>>> collectionSelector,
    ...
    public static ValueTask<Result<TResult>> SelectMany<TValue1, TValue2, TValue3, TValue4, TCollection, TResult>(
        this ValueTask<Result<TValue1, TValue2, TValue3, TValue4>>               awaitableSource,
        Func<TValue1, TValue2, TValue3, TValue4, ValueTask<Result<TCollection>>> collectionSelector,
        Func<TValue1, TValue2, TValue3, TValue4, TCollection, TResult>           resultSelector)
        where TValue1 : notnull
        where TValue2 : notnull
        where TValue3 : notnull
        where TValue4 : notnull
    ...
    public static ValueTask<Result<TResult>> SelectMany<TValue1, TValue2, TValue3, TValue4, TValue5, TCollection, TResult>(
        this Result<TValue1, TValue2, TValue3, TValue4, TValue5>                          source,
        Func<TValue1, TValue2, TValue3, TValue4, TValue5, ValueTask<Result<TCollection>>> collectionSelector,
    ...
    public static ValueTask<Result<TResult>> SelectMany<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TCollection, TResult>(
        this Result<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6>                          source,
        Func<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, ValueTask<Result<TCollection>>> collectionSelector,
    ...
    public static ValueTask<Result<TResult>> SelectMany<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TCollection, TResult>(
        this Result<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7>                          source,
        Func<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, ValueTask<Result<TCollection>>> collectionSelector,
    ...
    public static ValueTask<Result<TResult>> SelectMany<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TValue8, TCollection, TResult>(
        this Result<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TValue8>                          source,
        Func<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TValue8, ValueTask<Result<TCollection>>> collectionSelector,
