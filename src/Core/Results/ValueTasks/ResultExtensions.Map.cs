...
public static partial class ResultExtensions {
    ...
    public static ValueTask<Result<TOut1, TOut2>> Map<TValue1, TValue2, TOut1, TOut2>(this Result<TValue1, TValue2>                     result,
    ...
    public static ValueTask<Result<TOut1, TOut2>> Map<TValue1, TValue2, TOut1, TOut2>(this ValueTask<Result<TValue1, TValue2>>          awaitableResult,
                                                                                      Func<TValue1, TValue2, ValueTask<(TOut1, TOut2)>> map)
        where TValue1 : notnull
        where TValue2 : notnull
        where TOut1 : notnull
    ...
    public static ValueTask<Result<TOut1, TOut2, TOut3>> Map<TValue1, TValue2, TValue3, TOut1, TOut2, TOut3>(this Result<TValue1, TValue2, TValue3> result,
    ...
    public static ValueTask<Result<TOut1, TOut2, TOut3>> Map<TValue1, TValue2, TValue3, TOut1, TOut2, TOut3>(this ValueTask<Result<TValue1, TValue2, TValue3>> awaitableResult,
                                                                                                             Func<TValue1, TValue2, TValue3, ValueTask<(TOut1, TOut2, TOut3)>> map)
        where TValue1 : notnull
        where TValue2 : notnull
        where TValue3 : notnull
    ...
    public static ValueTask<Result<TOut1, TOut2, TOut3, TOut4>> Map<TValue1, TValue2, TValue3, TValue4, TOut1, TOut2, TOut3, TOut4>(
    ...
    public static ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5>> Map<TValue1, TValue2, TValue3, TValue4, TValue5, TOut1, TOut2, TOut3, TOut4, TOut5>(
    ...
    public static ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>> Map<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>(
    ...
    public static ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>> Map<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TOut1, TOut2, TOut3, TOut4,
                                                                                         TOut5, TOut6, TOut7>(
    ...
    public static ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7, TOut8>> Map<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TValue8, TOut1,
