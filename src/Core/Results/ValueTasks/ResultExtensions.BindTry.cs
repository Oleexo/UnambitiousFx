...
public static partial class ResultExtensions {
    ...
    public static ValueTask<Result<TOut1, TOut2, TOut3, TOut4>> BindTryAsync<TValue1, TOut1, TOut2, TOut3, TOut4>(this Result<TValue1> result,
        ...
        where TOut3 : notnull
        where TOut4 : notnull {
        return result.Match<ValueTask<Result<TOut1, TOut2, TOut3, TOut4>>>(async v => {
                                                                               try {
                                                                                   return await bind(v);
                                                                               }
                                                                               catch (Exception ex) {
    ...
    public static async ValueTask<Result<TOut1, TOut2, TOut3, TOut4>> BindTryAsync<TValue1, TOut1, TOut2, TOut3, TOut4>(this ValueTask<Result<TValue1>> awaitableResult,
        ...
        where TOut4 : notnull {
        var result = await awaitableResult;
        return await result.Match<ValueTask<Result<TOut1, TOut2, TOut3, TOut4>>>(async v => {
                                                                                     try {
                                                                                         return await bind(v);
                                                                                     }
                                                                                     catch (Exception ex) {
    ...
    public static ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5>> BindTryAsync<TValue1, TOut1, TOut2, TOut3, TOut4, TOut5>(this Result<TValue1> result,
        ...
        where TOut4 : notnull
        where TOut5 : notnull {
        return result.Match<ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5>>>(async v => {
                                                                                      try {
                                                                                          return await bind(v);
                                                                                      }
                                                                                      catch (Exception ex) {
    ...
    public static async ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5>> BindTryAsync<TValue1, TOut1, TOut2, TOut3, TOut4, TOut5>(
        ...
        where TOut5 : notnull {
        var result = await awaitableResult;
        return await result.Match<ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5>>>(async v => {
                                                                                            try {
                                                                                                return await bind(v);
                                                                                            }
                                                                                            catch (Exception ex) {
    ...
    public static ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>> BindTryAsync<TValue1, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>(this Result<TValue1> result,
        ...
        where TOut5 : notnull
        where TOut6 : notnull {
        return result.Match<ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>>>(async v => {
                                                                                             try {
                                                                                                 return await bind(v);
                                                                                             }
                                                                                             catch (Exception ex) {
    ...
    public static async ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>> BindTryAsync<TValue1, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>(
        this ValueTask<Result<TValue1>>                                            awaitableResult,
        Func<TValue1, ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>>> bind)
        where TValue1 : notnull
        where TOut1 : notnull
        ...
        where TOut6 : notnull {
        var result = await awaitableResult;
        return await result.Match<ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>>>(async v => {
                                                                                                   try {
                                                                                                       return await bind(v);
                                                                                                   }
                                                                                                   catch (Exception ex) {
    ...
    public static ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>> BindTryAsync<TValue1, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>(
        ...
        where TOut6 : notnull
        where TOut7 : notnull {
        return result.Match<ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>>>(async v => {
                                                                                                    try {
                                                                                                        return await bind(v);
                                                                                                    }
                                                                                                    catch (Exception ex) {
    ...
    public static async ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>> BindTryAsync<TValue1, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>(
        this ValueTask<Result<TValue1>>                                                   awaitableResult,
        Func<TValue1, ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>>> bind)
        where TValue1 : notnull
        where TOut1 : notnull
        ...
        where TOut7 : notnull {
        var result = await awaitableResult;
        return await result.Match<ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>>>(async v => {
                                                                                                          try {
                                                                                                              return await bind(v);
                                                                                                          }
                                                                                                          catch (Exception ex) {
                                                                                                              return Result
                                                                                                                 .Failure<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>(ex);
                                                                                                          }
                                                                                                      },
                                                                                                      e => new ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>>(
                                                                                                          Result.Failure<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>(e)));
    ...
    public static ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7, TOut8>> BindTryAsync<TValue1, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7, TOut8>(
        this Result<TValue1>                                                                     result,
        ...
        where TOut7 : notnull
        where TOut8 : notnull {
        return result.Match<ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7, TOut8>>>(async v => {
                                                                                                           try {
                                                                                                               return await bind(v);
                                                                                                           }
                                                                                                           catch (Exception ex) {
    ...
    public static async ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7, TOut8>> BindTryAsync<TValue1, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7, TOut8>(
        this ValueTask<Result<TValue1>>                                                          awaitableResult,
        Func<TValue1, ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7, TOut8>>> bind)
        where TValue1 : notnull
        where TOut1 : notnull
        ...
        where TOut8 : notnull {
        var result = await awaitableResult;
        return await result.Match<ValueTask<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7, TOut8>>>(async v => {
                                                                                                                 try {
                                                                                                                     return await bind(v);
                                                                                                                 }
                                                                                                                 catch (Exception ex) {
