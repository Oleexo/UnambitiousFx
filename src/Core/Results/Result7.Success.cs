    ...
    where TValue7 : notnull
{
    ...
    public override void Match(Action<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7> success, Action<Exception> failure) {
        success(_value1, _value2, _value3, _value4, _value5, _value6, _value7);
    }
    
    public override TOut Match<TOut>(Func<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TOut> success, Func<Exception, TOut> failure) {
    ...
    public override void Deconstruct(out bool isSuccess, out (TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7)? value, out Exception? error) {
        isSuccess = true;
