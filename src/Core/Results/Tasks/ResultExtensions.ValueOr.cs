...
public static partial class ResultExtensions {
    public static async Task<TValue1> ValueOr<TValue1>(this Task<Result<TValue1>> awaitableResult,
                                                       TValue1                    fallback)
    ...
    public static async Task<(TValue1, TValue2)> ValueOr<TValue1, TValue2>(this Task<Result<TValue1, TValue2>> awaitableResult,
    ...
    public static async Task<(TValue1, TValue2, TValue3)> ValueOr<TValue1, TValue2, TValue3>(this Task<Result<TValue1, TValue2, TValue3>> awaitableResult,
    ...
    public static async Task<(TValue1, TValue2, TValue3, TValue4)> ValueOr<TValue1, TValue2, TValue3, TValue4>(
    ...
    public static async Task<(TValue1, TValue2, TValue3, TValue4, TValue5)> ValueOr<TValue1, TValue2, TValue3, TValue4, TValue5>(
    ...
    public static async Task<(TValue1, TValue2, TValue3, TValue4, TValue5, TValue6)> ValueOr<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6>(
    ...
    public static async Task<(TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7)> ValueOr<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7>(
