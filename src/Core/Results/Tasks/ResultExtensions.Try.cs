...
public static partial class ResultExtensions {
    ...
    public static Task<Result<TOut>> TryAsync<TValue, TOut>(this Task<Result<TValue>> awaitableResult,
                                                            Func<TValue, Task<TOut>>  func)
        where TValue : notnull
        where TOut : notnull {
    ...
    public static Task<Result<TOut1, TOut2>> TryAsync<TValue1, TValue2, TOut1, TOut2>(this Task<Result<TValue1, TValue2>>          awaitableResult,
                                                                                      Func<TValue1, TValue2, Task<(TOut1, TOut2)>> func)
        where TValue1 : notnull
        where TValue2 : notnull
        where TOut1 : notnull
    ...
    public static Task<Result<TOut1, TOut2, TOut3>> TryAsync<TValue1, TValue2, TValue3, TOut1, TOut2, TOut3>(this Task<Result<TValue1, TValue2, TValue3>> awaitableResult,
                                                                                                             Func<TValue1, TValue2, TValue3, Task<(TOut1, TOut2, TOut3)>> func)
        where TValue1 : notnull
        where TValue2 : notnull
        where TValue3 : notnull
    ...
    public static Task<Result<TOut1, TOut2, TOut3, TOut4>> TryAsync<TValue1, TValue2, TValue3, TValue4, TOut1, TOut2, TOut3, TOut4>(
    ...
    public static Task<Result<TOut1, TOut2, TOut3, TOut4, TOut5>> TryAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TOut1, TOut2, TOut3, TOut4, TOut5>(
    ...
    public static Task<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>> TryAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>(
    ...
    public static Task<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>> TryAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TOut1, TOut2, TOut3, TOut4,
                                                                                         TOut5, TOut6, TOut7>(
    ...
    public static Task<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7, TOut8>> TryAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TValue8, TOut1,
