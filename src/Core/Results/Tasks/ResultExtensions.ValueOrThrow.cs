...
public static partial class ResultExtensions {
    public static async Task<TValue1> ValueOrThrow<TValue1>(this Task<Result<TValue1>> awaitable)
    ...
    public static async Task<(TValue1, TValue2)> ValueOrThrow<TValue1, TValue2>(this Task<Result<TValue1, TValue2>> awaitable)
        where TValue1 : notnull
    ...
    public static async Task<(TValue1, TValue2, TValue3)> ValueOrThrow<TValue1, TValue2, TValue3>(this Task<Result<TValue1, TValue2, TValue3>> awaitable)
        where TValue1 : notnull
        where TValue2 : notnull
    ...
    public static async Task<(TValue1, TValue2, TValue3, TValue4)> ValueOrThrow<TValue1, TValue2, TValue3, TValue4>(this Task<Result<TValue1, TValue2, TValue3, TValue4>> awaitable)
        where TValue1 : notnull
        where TValue2 : notnull
        where TValue3 : notnull
    ...
    public static async Task<(TValue1, TValue2, TValue3, TValue4, TValue5)> ValueOrThrow<TValue1, TValue2, TValue3, TValue4, TValue5>(
    ...
    public static async Task<(TValue1, TValue2, TValue3, TValue4, TValue5, TValue6)> ValueOrThrow<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6>(
    ...
    public static async Task<(TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7)> ValueOrThrow<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7>(
