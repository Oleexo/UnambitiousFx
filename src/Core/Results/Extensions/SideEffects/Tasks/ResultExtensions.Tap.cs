...
public static class ResultTapExtensions {
    ...
    public static async Task<Result<TValue>> TapAsync<TValue>(this Task<Result<TValue>> awaitableResult,
                                                              Func<TValue, Task>        tap)
        where TValue : notnull {
    ...
    public static async Task<Result<TValue1, TValue2>> TapAsync<TValue1, TValue2>(this Result<TValue1, TValue2> result,
    ...
    public static async Task<Result<TValue1, TValue2>> TapAsync<TValue1, TValue2>(this Task<Result<TValue1, TValue2>> awaitableResult,
                                                                                  Func<TValue1, TValue2, Task>        tap)
        where TValue1 : notnull
        where TValue2 : notnull {
        var result = await awaitableResult;
    ...
    public static async Task<Result<TValue1, TValue2, TValue3>> TapAsync<TValue1, TValue2, TValue3>(this Result<TValue1, TValue2, TValue3> result,
    ...
    public static async Task<Result<TValue1, TValue2, TValue3>> TapAsync<TValue1, TValue2, TValue3>(this Task<Result<TValue1, TValue2, TValue3>> awaitableResult,
                                                                                                    Func<TValue1, TValue2, TValue3, Task>        tap)
        where TValue1 : notnull
        where TValue2 : notnull
        where TValue3 : notnull {
    ...
    public static async Task<Result<TValue1, TValue2, TValue3, TValue4>> TapAsync<TValue1, TValue2, TValue3, TValue4>(this Result<TValue1, TValue2, TValue3, TValue4> result,
    ...
    public static async Task<Result<TValue1, TValue2, TValue3, TValue4>> TapAsync<TValue1, TValue2, TValue3, TValue4>(
    ...
    public static async Task<Result<TValue1, TValue2, TValue3, TValue4, TValue5>> TapAsync<TValue1, TValue2, TValue3, TValue4, TValue5>(
    ...
    public static async Task<Result<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6>> TapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6>(
    ...
    public static async Task<Result<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7>> TapAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7>(
