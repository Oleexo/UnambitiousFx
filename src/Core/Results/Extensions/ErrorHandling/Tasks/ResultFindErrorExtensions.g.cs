...
public static partial class ResultFindErrorExtensions
{
    ...
    public static async Task<IError?> FindErrorAsync(this Result result, Func<IError, Task<bool>> predicate) {
    ...
    /// <param name="predicate">The async predicate function to match errors.</param>
    /// <returns>A task containing the first error matching the predicate, or null if no match is found.</returns>
    public static async Task<IError?> FindErrorAsync<TValue1>(this Result<TValue1> result, Func<IError, Task<bool>> predicate) where TValue1 : notnull {
        foreach (var error in result.Reasons.OfType<IError>()) {
            if (await predicate(error)) {
                return error;
            }
    ...
    /// <param name="predicate">The async predicate function to match errors.</param>
    /// <returns>A task containing the first error matching the predicate, or null if no match is found.</returns>
    public static async Task<IError?> FindErrorAsync<TValue1>(this Task<Result<TValue1>> awaitableResult, Func<IError, Task<bool>> predicate) where TValue1 : notnull {
        var result = await awaitableResult;
        return await result.FindErrorAsync(predicate);
    }
    ...
    /// <param name="predicate">The async predicate function to match errors.</param>
    /// <returns>A task containing the first error matching the predicate, or null if no match is found.</returns>
    public static async Task<IError?> FindErrorAsync<TValue1, TValue2>(this Result<TValue1, TValue2> result, Func<IError, Task<bool>> predicate) where TValue1 : notnull where TValue2 : notnull {
        foreach (var error in result.Reasons.OfType<IError>()) {
            if (await predicate(error)) {
                return error;
            }
    ...
    /// <param name="predicate">The async predicate function to match errors.</param>
    /// <returns>A task containing the first error matching the predicate, or null if no match is found.</returns>
    public static async Task<IError?> FindErrorAsync<TValue1, TValue2, TValue3>(this Result<TValue1, TValue2, TValue3> result, Func<IError, Task<bool>> predicate) where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull {
        foreach (var error in result.Reasons.OfType<IError>()) {
            if (await predicate(error)) {
                return error;
            }
    ...
    /// <param name="predicate">The async predicate function to match errors.</param>
    /// <returns>A task containing the first error matching the predicate, or null if no match is found.</returns>
    public static async Task<IError?> FindErrorAsync<TValue1, TValue2, TValue3>(this Task<Result<TValue1, TValue2, TValue3>> awaitableResult, Func<IError, Task<bool>> predicate) where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull {
        var result = await awaitableResult;
        return await result.FindErrorAsync(predicate);
    }
    ...
    /// <param name="predicate">The async predicate function to match errors.</param>
    /// <returns>A task containing the first error matching the predicate, or null if no match is found.</returns>
    public static async Task<IError?> FindErrorAsync<TValue1, TValue2, TValue3, TValue4>(this Result<TValue1, TValue2, TValue3, TValue4> result, Func<IError, Task<bool>> predicate) where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull {
        foreach (var error in result.Reasons.OfType<IError>()) {
            if (await predicate(error)) {
                return error;
            }
    ...
    /// <param name="predicate">The async predicate function to match errors.</param>
    /// <returns>A task containing the first error matching the predicate, or null if no match is found.</returns>
    public static async Task<IError?> FindErrorAsync<TValue1, TValue2, TValue3, TValue4, TValue5>(this Result<TValue1, TValue2, TValue3, TValue4, TValue5> result, Func<IError, Task<bool>> predicate) where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull where TValue5 : notnull {
        foreach (var error in result.Reasons.OfType<IError>()) {
            if (await predicate(error)) {
                return error;
            }
    ...
    /// <param name="predicate">The async predicate function to match errors.</param>
    /// <returns>A task containing the first error matching the predicate, or null if no match is found.</returns>
    public static async Task<IError?> FindErrorAsync<TValue1, TValue2, TValue3, TValue4, TValue5>(this Task<Result<TValue1, TValue2, TValue3, TValue4, TValue5>> awaitableResult, Func<IError, Task<bool>> predicate) where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull where TValue5 : notnull {
        var result = await awaitableResult;
        return await result.FindErrorAsync(predicate);
    }
    ...
    /// <param name="predicate">The async predicate function to match errors.</param>
    /// <returns>A task containing the first error matching the predicate, or null if no match is found.</returns>
    public static async Task<IError?> FindErrorAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6>(this Result<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6> result, Func<IError, Task<bool>> predicate) where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull where TValue5 : notnull where TValue6 : notnull {
        foreach (var error in result.Reasons.OfType<IError>()) {
            if (await predicate(error)) {
                return error;
            }
    ...
    /// <param name="predicate">The async predicate function to match errors.</param>
    /// <returns>A task containing the first error matching the predicate, or null if no match is found.</returns>
    public static async Task<IError?> FindErrorAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7>(this Result<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7> result, Func<IError, Task<bool>> predicate) where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull where TValue5 : notnull where TValue6 : notnull where TValue7 : notnull {
        foreach (var error in result.Reasons.OfType<IError>()) {
            if (await predicate(error)) {
                return error;
            }
    ...
    /// <param name="predicate">The async predicate function to match errors.</param>
    /// <returns>A task containing the first error matching the predicate, or null if no match is found.</returns>
    public static async Task<IError?> FindErrorAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7>(this Task<Result<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7>> awaitableResult, Func<IError, Task<bool>> predicate) where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull where TValue5 : notnull where TValue6 : notnull where TValue7 : notnull {
        var result = await awaitableResult;
        return await result.FindErrorAsync(predicate);
    }
    ...
    /// <param name="predicate">The async predicate function to match errors.</param>
    /// <returns>A task containing the first error matching the predicate, or null if no match is found.</returns>
    public static async Task<IError?> FindErrorAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TValue8>(this Result<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7, TValue8> result, Func<IError, Task<bool>> predicate) where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull where TValue5 : notnull where TValue6 : notnull where TValue7 : notnull where TValue8 : notnull {
        foreach (var error in result.Reasons.OfType<IError>()) {
            if (await predicate(error)) {
                return error;
            }
