...
public static partial class ResultToNullableExtensions
{
    ...
    /// </summary>
    public static async Task<(TValue1, TValue2, TValue3, TValue4)?> ToNullableAsync<TValue1, TValue2, TValue3, TValue4>(this Task<Result<TValue1, TValue2, TValue3, TValue4>> awaitable) where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull {
