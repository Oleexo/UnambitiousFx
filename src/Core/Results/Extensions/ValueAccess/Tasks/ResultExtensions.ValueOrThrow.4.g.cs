...
public static partial class ResultValueOrThrowExtensions
{
    ...
    /// </summary>
    public static async Task<(TValue1, TValue2, TValue3, TValue4)> ValueOrThrowAsync<TValue1, TValue2, TValue3, TValue4>(this Task<Result<TValue1, TValue2, TValue3, TValue4>> resultTask) where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull {
    ...
    /// </summary>
    public static async Task<(TValue1, TValue2, TValue3, TValue4)> ValueOrThrowAsync<TValue1, TValue2, TValue3, TValue4>(this Task<Result<TValue1, TValue2, TValue3, TValue4>> resultTask, Func<IEnumerable<IError>, Exception> exceptionFactory) where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull {
        var result = await resultTask.ConfigureAwait(false);
