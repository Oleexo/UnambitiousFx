...
public static partial class ResultToNullableExtensions
{
    ...
    /// </summary>
    public static async Task<(TValue1, TValue2)?> ToNullableAsync<TValue1, TValue2>(this Task<Result<TValue1, TValue2>> awaitable) where TValue1 : notnull where TValue2 : notnull {
