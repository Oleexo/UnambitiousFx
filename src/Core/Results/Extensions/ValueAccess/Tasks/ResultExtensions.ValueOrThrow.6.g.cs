...
public static partial class ResultValueOrThrowExtensions
{
    ...
    /// </summary>
    public static async Task<(TValue1, TValue2, TValue3, TValue4, TValue5, TValue6)> ValueOrThrowAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6>(this Task<Result<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6>> resultTask) where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull where TValue5 : notnull where TValue6 : notnull {
