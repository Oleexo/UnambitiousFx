...
public static partial class ResultExtensions {
    ...
    public static async ValueTask<(TValue1, TValue2)> ValueOrAsync<TValue1, TValue2>(this ValueTask<Result<TValue1, TValue2>> awaitableResult,
                                                                                     TValue1                                  fallback1,
                                                                                     TValue2                                  fallback2)
        where TValue1 : notnull
    ...
    public static async ValueTask<(TValue1, TValue2, TValue3)> ValueOrAsync<TValue1, TValue2, TValue3>(this ValueTask<Result<TValue1, TValue2, TValue3>> awaitableResult,
                                                                                                       TValue1                                           fallback1,
                                                                                                       TValue2                                           fallback2,
                                                                                                       TValue3                                           fallback3)
        where TValue1 : notnull
    ...
    public static async ValueTask<(TValue1, TValue2, TValue3, TValue4)> ValueOrAsync<TValue1, TValue2, TValue3, TValue4>(
    ...
    public static async ValueTask<(TValue1, TValue2, TValue3, TValue4, TValue5)> ValueOrAsync<TValue1, TValue2, TValue3, TValue4, TValue5>(
    ...
    public static async ValueTask<(TValue1, TValue2, TValue3, TValue4, TValue5, TValue6)> ValueOrAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6>(
    ...
    public static async ValueTask<(TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7)> ValueOrAsync<TValue1, TValue2, TValue3, TValue4, TValue5, TValue6, TValue7>(
