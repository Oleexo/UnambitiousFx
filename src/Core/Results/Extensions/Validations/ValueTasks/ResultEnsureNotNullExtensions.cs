...
public static partial class ResultExtensions
{
    ...
    public static async ValueTask<Result<T>> EnsureNotNullAsync<T, TInner>(this ValueTask<Result<T>> awaitableResult, Func<T, TInner?> selector, string message, string? field = null) where T : notnull where TInner : class {
