...
public static partial class ResultBindExtensions {
    public static Task<Result> BindAsync<TValue1>(this Result<TValue1>        result,
                                                  Func<TValue1, Task<Result>> bind,
                                                  bool                        copyReasonsAndMetadata = true)
        where TValue1 : notnull {
        return result.Match(async v1 => {
    ...
    public static async Task<Result> BindAsync<TValue1>(this Task<Result<TValue1>>  awaitable,
                                                        Func<TValue1, Task<Result>> bind,
                                                        bool                        copyReasonsAndMetadata = true)
        where TValue1 : notnull {
    ...
    public static async Task<Result<TOut1>> BindAsync<TValue1, TOut1>(this Task<Result<TValue1>>         awaitable,
                                                                      Func<TValue1, Task<Result<TOut1>>> bind,
                                                                      bool                               copyReasonsAndMetadata = true)
        where TValue1 : notnull
        where TOut1 : notnull {
    ...
    public static async Task<Result<TOut1, TOut2>> BindAsync<TValue1, TOut1, TOut2>(this Task<Result<TValue1>>                awaitable,
                                                                                    Func<TValue1, Task<Result<TOut1, TOut2>>> bind,
                                                                                    bool                                      copyReasonsAndMetadata = true)
        where TValue1 : notnull
        where TOut1 : notnull
    ...
    // Sync binder overloads for Task<Result<TValue1>> -> Result
    public static async Task<Result> BindAsync<TValue1>(this Task<Result<TValue1>> awaitable,
    ...
    // Sync binder overloads for Task<Result<TValue1>> -> Result<TOut1..>
    public static async Task<Result<TOut1>> BindAsync<TValue1, TOut1>(this Task<Result<TValue1>>   awaitable,
    ...
    public static async Task<Result<TOut1, TOut2, TOut3>> BindAsync<TValue1, TOut1, TOut2, TOut3>(this Task<Result<TValue1>>                       awaitable,
                                                                                                  Func<TValue1, Task<Result<TOut1, TOut2, TOut3>>> bind,
                                                                                                  bool                                             copyReasonsAndMetadata = true)
        where TValue1 : notnull
        where TOut1 : notnull
    ...
    public static async Task<Result<TOut1, TOut2, TOut3, TOut4>> BindAsync<TValue1, TOut1, TOut2, TOut3, TOut4>(this Task<Result<TValue1>> awaitable,
                                                                                                                Func<TValue1, Task<Result<TOut1, TOut2, TOut3, TOut4>>> bind,
                                                                                                                bool copyReasonsAndMetadata = true)
        where TValue1 : notnull
        where TOut1 : notnull
    ...
    public static async Task<Result<TOut1, TOut2, TOut3, TOut4, TOut5>> BindAsync<TValue1, TOut1, TOut2, TOut3, TOut4, TOut5>(this Task<Result<TValue1>> awaitable,
        Func<TValue1, Task<Result<TOut1, TOut2, TOut3, TOut4, TOut5>>> bind,
        bool copyReasonsAndMetadata = true)
        where TValue1 : notnull
        where TOut1 : notnull
    ...
    public static async Task<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>> BindAsync<TValue1, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>(this Task<Result<TValue1>> awaitable,
        Func<TValue1, Task<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6>>> bind,
        bool copyReasonsAndMetadata = true)
        where TValue1 : notnull
        where TOut1 : notnull
    ...
    public static async Task<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>> BindAsync<TValue1, TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>(
        this Task<Result<TValue1>>                                                   awaitable,
        Func<TValue1, Task<Result<TOut1, TOut2, TOut3, TOut4, TOut5, TOut6, TOut7>>> bind,
        bool                                                                         copyReasonsAndMetadata = true)
        where TValue1 : notnull
        where TOut1 : notnull
