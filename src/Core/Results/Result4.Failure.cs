    ...
    where TValue4 : notnull
{
    ...
    public override void Match(Action<TValue1, TValue2, TValue3, TValue4> success, Action<Exception> failure) {
        failure(PrimaryException);
    }
    
    public override TOut Match<TOut>(Func<TValue1, TValue2, TValue3, TValue4, TOut> success, Func<Exception, TOut> failure) {
        return failure(PrimaryException);
    }
    ...
    public override bool Ok([NotNullWhen(true)] out TValue1? value1, [NotNullWhen(true)] out TValue2? value2, [NotNullWhen(true)] out TValue3? value3, [NotNullWhen(true)] out TValue4? value4, [NotNullWhen(false)] out Exception? error) {
        value1 = default;
        value2 = default;
        value3 = default;
        value4 = default;
    ...
    public override bool Ok([NotNullWhen(true)] out TValue1? value1, [NotNullWhen(true)] out TValue2? value2, [NotNullWhen(true)] out TValue3? value3, [NotNullWhen(true)] out TValue4? value4) {
        value1 = default;
        value2 = default;
        value3 = default;
        value4 = default;
    ...
    public override void Deconstruct(out bool isSuccess, out (TValue1, TValue2, TValue3, TValue4)? value, out Exception? error) {
        isSuccess = false;
        value = null;
        error = PrimaryException;
    }
