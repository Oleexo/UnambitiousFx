...
internal sealed class ResultBindExtensionsCodeGenerator : BaseCodeGenerator
{
    ...
    public ResultBindExtensionsCodeGenerator(string baseNamespace)
        : base(new GenerationConfig(
                   baseNamespace,
                   startArity: 0,  // Bind starts at 0 (Result with no values)
                   subNamespace: ExtensionsNamespace,
                   className: "ResultBindExtensions",
    ...
    protected override IReadOnlyCollection<ClassWriter> GenerateForArity(ushort arity)
    {
        ...
        return [
            ...
            GenerateAsyncMethodsForInputArity(inputArity, isValueTask: false),
            GenerateAsyncMethodsForInputArity(inputArity, isValueTask: true)
        ];
    }
    ...
    /// </summary>
    private ClassWriter GenerateAsyncMethodsForInputArity(ushort inputArity, bool isValueTask)
    {
