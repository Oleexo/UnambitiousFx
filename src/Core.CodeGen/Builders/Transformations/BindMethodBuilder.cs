...
internal sealed class BindMethodBuilder
{
    ...
    public MethodWriter BuildStandaloneMethod(ushort inputArity, ushort outputArity)
    {
        ...
        {
            var valueParams = string.Join(", ", Enumerable.Range(1, inputArity).Select(n => $"TValue{n}"));
            funcSignature = $"Func<{valueParams}, {outputResultType}>";
            matchSuccessParams = string.Join(", ", Enumerable.Range(1, inputArity).Select(n => $"v{n}"));
    ...
    /// </summary>
    public MethodWriter BuildResultWithAsyncFuncMethod(ushort inputArity, ushort outputArity, bool isValueTask)
    {
        var asyncType = isValueTask ? "ValueTask" : "Task";
        var taskCompletedMethod = isValueTask ? "new ValueTask<{0}>({1})" : "Task.FromResult({1})";
    ...
    /// </summary>
    public MethodWriter BuildAwaitableWithSyncFuncMethod(ushort inputArity, ushort outputArity, bool isValueTask)
    {
        var asyncType = isValueTask ? "ValueTask" : "Task";
    ...
    /// </summary>
    public MethodWriter BuildAwaitableWithAsyncFuncMethod(ushort inputArity, ushort outputArity, bool isValueTask)
    {
        var asyncType = isValueTask ? "ValueTask" : "Task";
