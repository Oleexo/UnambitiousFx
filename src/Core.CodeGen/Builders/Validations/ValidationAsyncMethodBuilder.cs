...
internal sealed class ValidationAsyncMethodBuilder
{
    ...
    /// </summary>
    public MethodWriter BuildEnsureAsync(ushort arity, bool isValueTask)
    {
        ...
        var docBuilder = DocumentationWriter.Create()
            .WithSummary("Validates the result values asynchronously with a predicate and returns a failure with the provided exception if validation fails.")
    ...
    /// </summary>
    public MethodWriter BuildEnsureAwaitableAsync(ushort arity, bool isValueTask)
    {
        var taskType = isValueTask ? "ValueTask" : "Task";
        var genericTypes = GenericTypeHelper.BuildGenericTypeString(arity, "TValue");
        var genericParams = GenericTypeHelper.CreateGenericParameters(arity, "TValue", "notnull");
        ...
        return new MethodWriter(
            ...
            body: body,
            visibility: Visibility.Public,
            modifier: MethodModifier.Static | MethodModifier.Async,
            parameters: [
    ...
    public MethodWriter BuildEnsureNotEmptyStringAsync(bool isValueTask)
    {
        ...
        return new MethodWriter(
            name: "EnsureNotEmptyAsync",
            returnType: $"{taskType}<Result<string>>",
            body: body,
            visibility: Visibility.Public,
            modifier: MethodModifier.Static | MethodModifier.Async,
            parameters: [
    ...
    public MethodWriter BuildEnsureNotEmptyCollectionAsync(bool isValueTask)
    {
        ...
        return new MethodWriter(
            name: "EnsureNotEmptyAsync",
            returnType: $"{taskType}<Result<TCollection>>",
            body: body,
            visibility: Visibility.Public,
            modifier: MethodModifier.Static | MethodModifier.Async,
            parameters: [
    ...
    public MethodWriter BuildEnsureNotNullAsync(bool isValueTask)
    {
        ...
        return new MethodWriter(
            name: "EnsureNotNullAsync",
            returnType: $"{taskType}<Result<T>>",
            body: body,
            visibility: Visibility.Public,
            modifier: MethodModifier.Static | MethodModifier.Async,
            parameters: [
