...
internal sealed record GenericConstraint(
    ...
    string? TypeName = null)
{
    ...
    public static GenericConstraint Class(string parameterName) =>
        new(parameterName, GenericConstraintType.Class);
    ...
    public static GenericConstraint Struct(string parameterName) =>
        new(parameterName, GenericConstraintType.Struct);
    ...
    public static GenericConstraint NotNull(string parameterName) =>
        new(parameterName, GenericConstraintType.NotNull);
    ...
    public static GenericConstraint Unmanaged(string parameterName) =>
        new(parameterName, GenericConstraintType.Unmanaged);
    ...
    public static GenericConstraint New(string parameterName) =>
        new(parameterName, GenericConstraintType.New);
    ...
    public static GenericConstraint BaseClass(string parameterName, string baseClassName) =>
        new(parameterName, GenericConstraintType.BaseClass, baseClassName);
    ...
    public static GenericConstraint Interface(string parameterName, string interfaceName) =>
        new(parameterName, GenericConstraintType.Interface, interfaceName);

    /// <summary>
    /// Gets the string representation of this constraint for use in C# code.
    /// </summary>
    /// <returns>The constraint string.</returns>
    public string ToConstraintString() => Type switch
    {
