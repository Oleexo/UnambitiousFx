...
public sealed class ResultTests {
    ...
    public async Task GivenResultWithArityOf1_ShouldBeAbleToBindToArityOf2Async() {
        ...
        var result2 = await Results.Tasks.ResultExtensions.Bind(result, x => Task.FromResult(Result.Success(x, x + 1)));
    ...
    public async Task GivenResultWithArityOf3_ShouldBeAbleToBindToArityOf2Async() {
        ...
        var result2 = await Results.Tasks.ResultExtensions.Bind(result, (x,
                                                                         y,
