...
namespace UnambitiousFx.Core.Tests.Results.Extensions.ValueAccess.ToNullable.ValueTasks;
...
public sealed class ResultToNullableExtensionsTests {
    ...
    public async Task ToNullableAsync_Arity2_Success_ReturnsTuple() {
        var awaitable = new ValueTask<Result<int, int>>(Result.Success(2, 3));
        var n = await awaitable.ToNullableAsync();
        Assert.Equal((2, 3), n);
    }
    ...
    public async Task ToNullableAsync_Arity2_Failure_ReturnsNull() {
        var awaitable = new ValueTask<Result<int, int>>(Result.Failure<int, int>(new InvalidOperationException("fail")));
        var n = await awaitable.ToNullableAsync();
    ...
    public async Task ToNullableAsync_Arity3_Failure_ReturnsNull() {
        var awaitable = new ValueTask<Result<int, int, int>>(Result.Failure<int, int, int>(new Exception("boom3")));
        var n = await awaitable.ToNullableAsync();
    ...
    public async Task ToNullableAsync_Arity4_Failure_ReturnsNull() {
        var awaitable = new ValueTask<Result<int, int, int, int>>(Result.Failure<int, int, int, int>(new Exception("boom4")));
        var n = await awaitable.ToNullableAsync();
    ...
    public async Task ToNullableAsync_Arity5_Failure_ReturnsNull() {
        var awaitable = new ValueTask<Result<int, int, int, int, int>>(Result.Failure<int, int, int, int, int>(new Exception("boom5")));
        var n = await awaitable.ToNullableAsync();
    ...
    public async Task ToNullableAsync_Arity6_Failure_ReturnsNull() {
        var awaitable = new ValueTask<Result<int, int, int, int, int, int>>(Result.Failure<int, int, int, int, int, int>(new Exception("boom6")));
        var n = await awaitable.ToNullableAsync();
    ...
    public async Task ToNullableAsync_Arity7_Failure_ReturnsNull() {
        var awaitable = new ValueTask<Result<int, int, int, int, int, int, int>>(Result.Failure<int, int, int, int, int, int, int>(new Exception("boom7")));
        var n = await awaitable.ToNullableAsync();
    ...
    public async Task ToNullableAsync_Arity8_Failure_ReturnsNull() {
        var awaitable = new ValueTask<Result<int, int, int, int, int, int, int, int>>(Result.Failure<int, int, int, int, int, int, int, int>(new Exception("boom8")));
        var n = await awaitable.ToNullableAsync();
