...
public class ResultValueOrThrowValueTaskTestsArity1
{
    ...
    public async Task ValueOrThrowValueTask_Arity1_Failure_ShouldThrowException() {
        ...
        // When & Then
        await Assert.ThrowsAsync<Exception>(async () => await valueTaskResult.ValueOrThrowAsync());
    }
    ...
    public async Task ValueOrThrowValueTaskWithFactory_Arity1_Success_ShouldReturnValue() {
        ...
        // When
        var actualValue = await valueTaskResult.ValueOrThrowAsync(exceptionFactory);
        // Then
        Assert.Equal(value1, actualValue);
    }
    ...
    public async Task ValueOrThrowValueTaskWithFactory_Arity1_Failure_ShouldThrowCustomException() {
        ...
        Func<IEnumerable<IError>, Exception> exceptionFactory = errors => new InvalidOperationException("Custom error");
        // When & Then
        await Assert.ThrowsAsync<InvalidOperationException>(async () => await valueTaskResult.ValueOrThrowAsync(exceptionFactory));
    }
