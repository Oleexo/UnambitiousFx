...
namespace UnambitiousFx.Core.Tests.Results.Extensions.ValueOrThrow;
...
public class ResultValueOrThrowTests {
    ...
    [Fact]
    public async System.Threading.Tasks.Task ValueOrThrow_Task_Success() {
        var task = System.Threading.Tasks.Task.FromResult(Result.Success(9));
        var v    = await task.ValueOrThrow();
        Assert.Equal(9, v);
    }

    [Fact]
    public async System.Threading.Tasks.Task ValueOrThrow_Task_Failure() {
        var ex     = new Exception("task");
        var task   = System.Threading.Tasks.Task.FromResult(Result.Failure<int>(ex));
        var thrown = await Assert.ThrowsAsync<Exception>(async () => await task.ValueOrThrow());
        Assert.Same(ex, thrown);
    }

    [Fact]
    public async System.Threading.Tasks.Task ValueOrThrow_Task_Factory_Transforms() {
    ...
    [Fact]
    public async System.Threading.Tasks.Task ValueOrThrow_ValueTask_Success() {
    ...
    [Fact]
    public async System.Threading.Tasks.Task ValueOrThrow_ValueTask_Failure() {
    ...
    [Fact]
    public async System.Threading.Tasks.Task ValueOrThrow_ValueTask_Factory_Transforms() {
