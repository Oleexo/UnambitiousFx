...
public sealed class ResultExtensionsTests {
    ...
    public async Task ZipAsync_Arity2_BothSuccess_ReturnsTuple() {
        var r1 = ValueTask.FromResult(Result.Success(10));
        var r2 = ValueTask.FromResult(Result.Success("x"));
    ...
    public async Task ZipAsync_Arity2_SecondFailure_Propagates() {
        ...
        var r2 = ValueTask.FromResult(Result.Failure<string>(ex));
    ...
    public async Task ZipAsync_Arity2_WithProjector_Success_ReturnsProjected() {
        var r1 = ValueTask.FromResult(Result.Success(20));
        var r2 = ValueTask.FromResult(Result.Success(22));
    ...
    public async Task ZipAsync_Arity2_WithProjector_FirstFailure_Propagates() {
        ...
        var r1 = ValueTask.FromResult(Result.Success(1));
        var r2 = ValueTask.FromResult(Result.Failure<int>(ex));
    ...
    public async Task ZipAsync_Arity2_WithProjector_SecondFailure_Propagates() {
        var ex = new Exception("zp");
        var r1 = ValueTask.FromResult(Result.Failure<int>(ex));
        var r2 = ValueTask.FromResult(Result.Success(1));
    ...
    public async Task ZipAsync_Arity3_ThirdFailure_Propagates() {
        ...
        var r1 = ValueTask.FromResult(Result.Success(1));
        var r2 = ValueTask.FromResult(Result.Success(2));
        var r3 = ValueTask.FromResult(Result.Failure<int>(ex));
    ...
    public async Task ZipAsync_Arity7_SeventhFailure_Propagates() {
        ...
        var r5 = ValueTask.FromResult(Result.Success(5));
        var r6 = ValueTask.FromResult(Result.Success(6));
        var r7 = ValueTask.FromResult(Result.Failure<int>(ex));
