...
public sealed class FromArity1BindTests {
    [Fact]
    public void Bind_1_To_0_Success() {
        Result.Success(1)
    ...
    [Fact]
    public void Bind_1_To_0_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;

        Result.Failure<int>(ex)
              .Bind(_ => {
                   called = true;
    ...
    [Fact]
    public void Bind_1_To_1_Success() {
        var r = Result.Success(1)
                      .Bind(_ => Result.Success(10));
        r.ShouldBeSuccess(out var v);
        Assert.Equal(10, v);
    }

    [Fact]
    public void Bind_1_To_1_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
    ...
    [Fact]
    public void Bind_1_To_2_Success() {
        var r = Result.Success(1)
                      .Bind(_ => Result.Success(1, 2));
        r.ShouldBeSuccess(out var v);
        Assert.Equal((1, 2), v);
    }

    [Fact]
    public void Bind_1_To_2_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
        var res = Result.Failure<int>(ex)
                        .Bind(_ => {
    ...
    [Fact]
    public void Bind_1_To_3_Success() {
        var r = Result.Success(1)
                      .Bind(_ => Result.Success(1, 2, 3));
        r.ShouldBeSuccess(out var v);
        Assert.Equal((1, 2, 3), v);
    }

    [Fact]
    public void Bind_1_To_3_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
        var res = Result.Failure<int>(ex)
                        .Bind(_ => {
    ...
    [Fact]
    public void Bind_1_To_4_Success() {
        var r = Result.Success(1)
                      .Bind(_ => Result.Success(1, 2, 3, 4));
        r.ShouldBeSuccess(out var v);
        Assert.Equal((1, 2, 3, 4), v);
    }

    [Fact]
    public void Bind_1_To_4_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
        var res = Result.Failure<int>(ex)
                        .Bind(_ => {
    ...
    [Fact]
    public void Bind_1_To_5_Success() {
        var r = Result.Success(1)
                      .Bind(_ => Result.Success(1, 2, 3, 4, 5));
        r.ShouldBeSuccess(out var v);
        Assert.Equal((1, 2, 3, 4, 5), v);
    }

    [Fact]
    public void Bind_1_To_5_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
        var res = Result.Failure<int>(ex)
                        .Bind(_ => {
    ...
    [Fact]
    public void Bind_1_To_7_Success() {
        var r = Result.Success(1)
                      .Bind(_ => Result.Success(1, 2, 3, 4, 5, 6, 7));
        r.ShouldBeSuccess(out var v);
        Assert.Equal((1, 2, 3, 4, 5, 6, 7), v);
    }

    [Fact]
    public void Bind_1_To_7_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
        var res = Result.Failure<int>(ex)
                        .Bind(_ => {
