...
public sealed class ToArity1BindTests {
    [Fact]
    ...
    [Fact]
    public void Bind_2_To_1_Success() {
    ...
    [Fact]
    public void Bind_2_To_1_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
    ...
    [Fact]
    public void Bind_3_To_1_Success() {
    ...
    [Fact]
    public void Bind_3_To_1_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
