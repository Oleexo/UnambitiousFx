...
public sealed class ToArity5BindTests {
    [Fact]
    ...
    [Fact]
    public void Bind_2_To_5_Success() {
    ...
    [Fact]
    public void Bind_2_To_5_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
    ...
    [Fact]
    public void Bind_3_To_5_Success() {
    ...
    [Fact]
    public void Bind_3_To_5_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
    ...
    [Fact]
    public void Bind_8_To_5_Success() {
    ...
    [Fact]
    public void Bind_8_To_5_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
