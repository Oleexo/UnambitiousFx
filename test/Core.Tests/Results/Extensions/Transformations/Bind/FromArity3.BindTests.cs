...
public sealed class FromArity3BindTests {
    [Fact]
    public void Bind_3_To_0_Success() {
    ...
    [Fact]
    public void Bind_3_To_0_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;

        Result.Failure<int, int, int>(ex)
              .Bind((_,
                     _,
                     _) => {
                   called = true;
    ...
    [Fact]
    public void Bind_3_To_4_Success() {
        var r = Result.Success(1, 2, 3)
                      .Bind((_,
                             _,
    ...
    [Fact]
    public void Bind_3_To_4_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
        var res = Result.Failure<int, int, int>(ex)
                        .Bind((_,
