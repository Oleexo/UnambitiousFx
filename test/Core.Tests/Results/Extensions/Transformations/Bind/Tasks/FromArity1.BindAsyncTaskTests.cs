...
public sealed class FromArity1BindAsyncTaskTests {
    [Fact]
    ...
    public async Task BindAsync_1_To_1_Success() {
        var r = await Result.Success(1)
                             .BindAsync(_ => Task.FromResult(Result.Success(10)));
    ...
    public async Task BindAsync_1_To_2_Success() {
        var r = await Result.Success(1)
                             .BindAsync(_ => Task.FromResult(Result.Success(1, 2)));
        r.ShouldBeSuccess(out var v);
        Assert.Equal((1, 2), v);
    }
    ...
    public async Task BindAsync_1_To_3_Success() {
        var r = await Result.Success(1)
                             .BindAsync(_ => Task.FromResult(Result.Success(1, 2, 3)));
        r.ShouldBeSuccess(out var v);
    ...
    public async Task BindAsync_1_To_4_Success() {
        var r = await Result.Success(1)
                             .BindAsync(_ => Task.FromResult(Result.Success(1, 2, 3, 4)));
        r.ShouldBeSuccess(out var v);
    ...
    public async Task BindAsync_1_To_5_Success() {
        var r = await Result.Success(1)
                             .BindAsync(_ => Task.FromResult(Result.Success(1, 2, 3, 4, 5)));
        r.ShouldBeSuccess(out var v);
    ...
    public async Task BindAsync_1_To_7_Success() {
        var r = await Result.Success(1)
                             .BindAsync(_ => Task.FromResult(Result.Success(1, 2, 3, 4, 5, 6, 7)));
        r.ShouldBeSuccess(out var v);
    ...
    public async Task BindAsync_1_To_8_Success() {
        var r = await Result.Success(1)
                             .BindAsync(_ => Task.FromResult(Result.Success(1, 2, 3, 4, 5, 6, 7, 8)));
        r.ShouldBeSuccess(out var v);
    ...
    public async Task BindAsync_Awaitable1_To_0_AsyncBind_Success_NoCopy() {
        ...
        var r = await awaitable.BindAsync(_ => Task.FromResult(Result.Success()), copyReasonsAndMetadata: false);
    ...
    public async Task BindAsync_Awaitable1_To_1_AsyncBind_Success_NoCopy() {
        ...
        var r = await awaitable.BindAsync(_ => Task.FromResult(Result.Success(10)), copyReasonsAndMetadata: false);
    ...
    public async Task BindAsync_Awaitable1_To_2_AsyncBind_Success_NoCopy() {
        ...
        var r = await awaitable.BindAsync(_ => Task.FromResult(Result.Success(1, 2)), copyReasonsAndMetadata: false);
    ...
    public async Task BindAsync_Awaitable1_To_3_AsyncBind_Success_NoCopy() {
        ...
        var r = await awaitable.BindAsync(_ => Task.FromResult(Result.Success(1, 2, 3)), copyReasonsAndMetadata: false);
    ...
    public async Task BindAsync_Awaitable1_To_4_AsyncBind_Success_NoCopy() {
        ...
        var r = await awaitable.BindAsync(_ => Task.FromResult(Result.Success(1, 2, 3, 4)), copyReasonsAndMetadata: false);
    ...
    public async Task BindAsync_Awaitable1_To_5_AsyncBind_Success_NoCopy() {
        ...
        var r = await awaitable.BindAsync(_ => Task.FromResult(Result.Success(1, 2, 3, 4, 5)), copyReasonsAndMetadata: false);
    ...
    public async Task BindAsync_Awaitable1_To_6_AsyncBind_Success_NoCopy() {
        ...
        var r = await awaitable.BindAsync(_ => Task.FromResult(Result.Success(1, 2, 3, 4, 5, 6)), copyReasonsAndMetadata: false);
    ...
    public async Task BindAsync_Awaitable1_To_7_AsyncBind_Success_NoCopy() {
        ...
        var r = await awaitable.BindAsync(_ => Task.FromResult(Result.Success(1, 2, 3, 4, 5, 6, 7)), copyReasonsAndMetadata: false);
    ...
    public async Task BindAsync_Awaitable1_To_8_AsyncBind_Success_NoCopy() {
        ...
        var r = await awaitable.BindAsync(_ => Task.FromResult(Result.Success(1, 2, 3, 4, 5, 6, 7, 8)), copyReasonsAndMetadata: false);
