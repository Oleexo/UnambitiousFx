...
public sealed class ToArity3BindTests {
    [Fact]
    ...
    [Fact]
    public void Bind_2_To_3_Success() {
    ...
    [Fact]
    public void Bind_2_To_3_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
    ...
    [Fact]
    public void Bind_3_To_3_Success() {
    ...
    [Fact]
    public void Bind_3_To_3_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
    ...
    [Fact]
    public void Bind_8_To_3_Success() {
    ...
    [Fact]
    public void Bind_8_To_3_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
