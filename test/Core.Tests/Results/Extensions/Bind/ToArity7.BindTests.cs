...
public sealed class ToArity7BindTests {
    [Fact]
    ...
    [Fact]
    public void Bind_2_To_7_Success() {
    ...
    [Fact]
    public void Bind_2_To_7_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
    ...
    [Fact]
    public void Bind_3_To_7_Success() {
    ...
    [Fact]
    public void Bind_3_To_7_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
    ...
    [Fact]
    public void Bind_8_To_7_Success() {
    ...
    [Fact]
    public void Bind_8_To_7_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
