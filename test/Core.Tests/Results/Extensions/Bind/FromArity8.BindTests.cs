...
public sealed class FromArity8BindTests {
    [Fact]
    public void Bind_8_To_0_Success() {
    ...
    [Fact]
    public void Bind_8_To_0_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;

        Result.Failure<int, int, int, int, int, int, int, int>(ex)
              .Bind((_,
                     _,
                     _,
                     _,
    ...
    [Fact]
    public void Bind_8_To_1_Success() {
    ...
    [Fact]
    public void Bind_8_To_1_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
    ...
    [Fact]
    public void Bind_8_To_2_Success() {
        var r = Result.Success(1, 2, 3, 4, 5, 6, 7, 8)
                      .Bind((_,
                             _,
                             _,
    ...
    [Fact]
    public void Bind_8_To_2_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
        var res = Result.Failure<int, int, int, int, int, int, int, int>(ex)
                        .Bind((_,
    ...
    [Fact]
    public void Bind_8_To_4_Success() {
        var r = Result.Success(1, 2, 3, 4, 5, 6, 7, 8)
                      .Bind((_,
                             _,
                             _,
    ...
    [Fact]
    public void Bind_8_To_4_Failure_DoesNotInvoke() {
        var ex     = new Exception("err");
        var called = false;
        var res = Result.Failure<int, int, int, int, int, int, int, int>(ex)
                        .Bind((_,
