...
public sealed class ResultExtensionsTests {
    ...
    public async Task TapAsync_Arity1_Success_InvokesOnce() {
        ...
        var called = 0;
        await r.TapAsync(_ => { called++; return Task.CompletedTask; });
    ...
    public async Task TapAsync_Arity2_Success_InvokesOnce() {
        ...
        var called = 0;
        await r.TapAsync((_, _) => { called++; return Task.CompletedTask; });
        Assert.Equal(1, called);
    }
    ...
    public async Task TapAsync_Arity3_Success_InvokesOnce() {
        ...
        var called = 0;
        await r.TapAsync((_, _, _) => { called++; return Task.CompletedTask; });
        Assert.Equal(1, called);
    }
    ...
    public async Task TapAsync_Arity4_Success_InvokesOnce() {
        ...
        var called = 0;
        await r.TapAsync((_, _, _, _) => { called++; return Task.CompletedTask; });
        Assert.Equal(1, called);
    }
    ...
    public async Task TapAsync_Arity5_Success_InvokesOnce() {
        ...
        var called = 0;
        await r.TapAsync((_, _, _, _, _) => { called++; return Task.CompletedTask; });
        Assert.Equal(1, called);
    }
    ...
    public async Task TapAsync_Arity6_Success_InvokesOnce() {
        ...
        var called = 0;
        await r.TapAsync((_, _, _, _, _, _) => { called++; return Task.CompletedTask; });
        Assert.Equal(1, called);
    }
    ...
    public async Task TapAsync_Arity7_Success_InvokesOnce() {
        ...
        var called = 0;
        await r.TapAsync((_, _, _, _, _, _, _) => { called++; return Task.CompletedTask; });
        Assert.Equal(1, called);
    }
    ...
    public async Task TapAsync_Arity8_Success_InvokesOnce() {
        ...
        var called = 0;
        await r.TapAsync((_, _, _, _, _, _, _, _) => { called++; return Task.CompletedTask; });
        Assert.Equal(1, called);
    }
