...
public sealed class ResultExtensionsAwaitableTests {
    #region Arity 1
    [Fact]
    public async Task TapAsync_ValueTask_Arity1_Success_InvokesOnce() {
        var awaitable = new ValueTask<Result<int>>(Result.Success(42));
        var called = 0;
        await awaitable.TapAsync(_ => { called++; return new ValueTask(); });
        Assert.Equal(1, called);
    }

    [Fact]
    public async Task TapAsync_ValueTask_Arity1_Failure_DoesNotInvoke() {
    ...
    #region Arity 2
    [Fact]
    public async Task TapAsync_ValueTask_Arity2_Success_InvokesOnce() {
        var awaitable = new ValueTask<Result<int, int>>(Result.Success(1, 2));
        var called = 0;
        await awaitable.TapAsync((_, _) => { called++; return new ValueTask(); });
        Assert.Equal(1, called);
    }

    [Fact]
    public async Task TapAsync_ValueTask_Arity2_Failure_DoesNotInvoke() {
    ...
    #region Arity 3
    [Fact]
    public async Task TapAsync_ValueTask_Arity3_Success_InvokesOnce() {
        var awaitable = new ValueTask<Result<int, int, int>>(Result.Success(1, 2, 3));
        var called = 0;
        await awaitable.TapAsync((_, _, _) => { called++; return new ValueTask(); });
        Assert.Equal(1, called);
    }

    [Fact]
    public async Task TapAsync_ValueTask_Arity3_Failure_DoesNotInvoke() {
    ...
    #region Arity 4
    [Fact]
    public async Task TapAsync_ValueTask_Arity4_Success_InvokesOnce() {
        var awaitable = new ValueTask<Result<int, int, int, int>>(Result.Success(1, 2, 3, 4));
        var called = 0;
        await awaitable.TapAsync((_, _, _, _) => { called++; return new ValueTask(); });
        Assert.Equal(1, called);
    }

    [Fact]
    public async Task TapAsync_ValueTask_Arity4_Failure_DoesNotInvoke() {
    ...
    #region Arity 5
    [Fact]
    public async Task TapAsync_ValueTask_Arity5_Success_InvokesOnce() {
        var awaitable = new ValueTask<Result<int, int, int, int, int>>(Result.Success(1, 2, 3, 4, 5));
        var called = 0;
        await awaitable.TapAsync((_, _, _, _, _) => { called++; return new ValueTask(); });
        Assert.Equal(1, called);
    }

    [Fact]
    public async Task TapAsync_ValueTask_Arity5_Failure_DoesNotInvoke() {
    ...
    #region Arity 6
    [Fact]
    public async Task TapAsync_ValueTask_Arity6_Success_InvokesOnce() {
        var awaitable = new ValueTask<Result<int, int, int, int, int, int>>(Result.Success(1, 2, 3, 4, 5, 6));
        var called = 0;
        await awaitable.TapAsync((_, _, _, _, _, _) => { called++; return new ValueTask(); });
        Assert.Equal(1, called);
    }

    [Fact]
    public async Task TapAsync_ValueTask_Arity6_Failure_DoesNotInvoke() {
    ...
    #region Arity 7
    [Fact]
    public async Task TapAsync_ValueTask_Arity7_Success_InvokesOnce() {
        var awaitable = new ValueTask<Result<int, int, int, int, int, int, int>>(Result.Success(1, 2, 3, 4, 5, 6, 7));
        var called = 0;
        await awaitable.TapAsync((_, _, _, _, _, _, _) => { called++; return new ValueTask(); });
        Assert.Equal(1, called);
    }

    [Fact]
    public async Task TapAsync_ValueTask_Arity7_Failure_DoesNotInvoke() {
    ...
    #region Arity 8
    [Fact]
    public async Task TapAsync_ValueTask_Arity8_Success_InvokesOnce() {
        var awaitable = new ValueTask<Result<int, int, int, int, int, int, int, int>>(Result.Success(1, 2, 3, 4, 5, 6, 7, 8));
        var called = 0;
        await awaitable.TapAsync((_, _, _, _, _, _, _, _) => { called++; return new ValueTask(); });
        Assert.Equal(1, called);
    }

    [Fact]
    public async Task TapAsync_ValueTask_Arity8_Failure_DoesNotInvoke() {
