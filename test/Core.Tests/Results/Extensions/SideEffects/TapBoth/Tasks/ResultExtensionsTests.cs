...
namespace UnambitiousFx.Core.Tests.Results.Extensions.SideEffects.TapBoth.Tasks;
...
public sealed class ResultExtensionsTests {
    ...
    public async Task TapBothAsync_Arity1_Success_InvokesSuccess() {
        ...
        var success = 0;
        await r.TapBothAsync(_ => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
    ...
    public async Task TapBothAsync_Arity1_Success_DoesNotInvokeError() {
        var r = Result.Success(1);
        var error = 0;
        await r.TapBothAsync(_ => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
    ...
    // Awaitable overloads (Task<Result<T>>)
    [Fact]
    public async Task TapBothAsync_Awaitable_Arity1_Success_InvokesSuccess() {
        var awaitable = Task.FromResult(Result.Success(1));
        var success = 0;
        await awaitable.TapBothAsync(_ => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Awaitable_Arity1_Success_DoesNotInvokeError() {
        var awaitable = Task.FromResult(Result.Success(1));
        var error = 0;
        await awaitable.TapBothAsync(_ => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    public async Task TapBothAsync_Arity2_Success_InvokesSuccess() {
        ...
        var success = 0;
        await r.TapBothAsync((_, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Arity2_Success_DoesNotInvokeError() {
        var r = Result.Success(1, 2);
        var error = 0;
        await r.TapBothAsync((_, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    // Awaitable overloads (Task<Result<T1,T2>>)
    [Fact]
    public async Task TapBothAsync_Awaitable_Arity2_Success_InvokesSuccess() {
        var awaitable = Task.FromResult(Result.Success(1, 2));
        var success = 0;
        await awaitable.TapBothAsync((_, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Awaitable_Arity2_Success_DoesNotInvokeError() {
        var awaitable = Task.FromResult(Result.Success(1, 2));
        var error = 0;
        await awaitable.TapBothAsync((_, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    public async Task TapBothAsync_Arity3_Success_InvokesSuccess() {
        ...
        var success = 0;
        await r.TapBothAsync((_, _, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Arity3_Success_DoesNotInvokeError() {
        var r = Result.Success(1, 2, 3);
        var error = 0;
        await r.TapBothAsync((_, _, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    // Awaitable overloads (Task<Result<T1,T2,T3>>)
    [Fact]
    public async Task TapBothAsync_Awaitable_Arity3_Success_InvokesSuccess() {
        var awaitable = Task.FromResult(Result.Success(1, 2, 3));
        var success = 0;
        await awaitable.TapBothAsync((_, _, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Awaitable_Arity3_Success_DoesNotInvokeError() {
        var awaitable = Task.FromResult(Result.Success(1, 2, 3));
        var error = 0;
        await awaitable.TapBothAsync((_, _, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    public async Task TapBothAsync_Arity4_Success_InvokesSuccess() {
        ...
        var success = 0;
        await r.TapBothAsync((_, _, _, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Arity4_Success_DoesNotInvokeError() {
        var r = Result.Success(1, 2, 3, 4);
        var error = 0;
        await r.TapBothAsync((_, _, _, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    // Awaitable overloads (Task<Result<T1,T2,T3,T4>>)
    [Fact]
    public async Task TapBothAsync_Awaitable_Arity4_Success_InvokesSuccess() {
        ...
        var success = 0;
        await awaitable.TapBothAsync((_, _, _, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Awaitable_Arity4_Success_DoesNotInvokeError() {
        var awaitable = Task.FromResult(Result.Success(1, 2, 3, 4));
        var error = 0;
        await awaitable.TapBothAsync((_, _, _, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    public async Task TapBothAsync_Arity5_Success_InvokesSuccess() {
        ...
        var success = 0;
        await r.TapBothAsync((_, _, _, _, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Arity5_Success_DoesNotInvokeError() {
        var r = Result.Success(1, 2, 3, 4, 5);
        var error = 0;
        await r.TapBothAsync((_, _, _, _, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    // Awaitable overloads (Task<Result<T1,T2,T3,T4,T5>>)
    [Fact]
    public async Task TapBothAsync_Awaitable_Arity5_Success_InvokesSuccess() {
        ...
        var success = 0;
        await awaitable.TapBothAsync((_, _, _, _, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Awaitable_Arity5_Success_DoesNotInvokeError() {
        var awaitable = Task.FromResult(Result.Success(1, 2, 3, 4, 5));
        var error = 0;
        await awaitable.TapBothAsync((_, _, _, _, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    public async Task TapBothAsync_Arity6_Success_InvokesSuccess() {
        ...
        var success = 0;
        await r.TapBothAsync((_, _, _, _, _, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Arity6_Success_DoesNotInvokeError() {
        var r = Result.Success(1, 2, 3, 4, 5, 6);
        var error = 0;
        await r.TapBothAsync((_, _, _, _, _, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    // Awaitable overloads (Task<Result<T1,T2,T3,T4,T5,T6>>)
    [Fact]
    public async Task TapBothAsync_Awaitable_Arity6_Success_InvokesSuccess() {
        ...
        var success = 0;
        await awaitable.TapBothAsync((_, _, _, _, _, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Awaitable_Arity6_Success_DoesNotInvokeError() {
        var awaitable = Task.FromResult(Result.Success(1, 2, 3, 4, 5, 6));
        var error = 0;
        await awaitable.TapBothAsync((_, _, _, _, _, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    public async Task TapBothAsync_Arity7_Success_InvokesSuccess() {
        ...
        var success = 0;
        await r.TapBothAsync((_, _, _, _, _, _, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Arity7_Success_DoesNotInvokeError() {
        var r = Result.Success(1, 2, 3, 4, 5, 6, 7);
        var error = 0;
        await r.TapBothAsync((_, _, _, _, _, _, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    // Awaitable overloads (Task<Result<T1,T2,T3,T4,T5,T6,T7>>)
    [Fact]
    public async Task TapBothAsync_Awaitable_Arity7_Success_InvokesSuccess() {
        ...
        var success = 0;
        await awaitable.TapBothAsync((_, _, _, _, _, _, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Awaitable_Arity7_Success_DoesNotInvokeError() {
        var awaitable = Task.FromResult(Result.Success(1, 2, 3, 4, 5, 6, 7));
        var error = 0;
        await awaitable.TapBothAsync((_, _, _, _, _, _, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    public async Task TapBothAsync_Arity8_Success_InvokesSuccess() {
        ...
        var success = 0;
        await r.TapBothAsync((_, _, _, _, _, _, _, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Arity8_Success_DoesNotInvokeError() {
        var r = Result.Success(1, 2, 3, 4, 5, 6, 7, 8);
        var error = 0;
        await r.TapBothAsync((_, _, _, _, _, _, _, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
    ...
    // Awaitable overloads (Task<Result<T1,T2,T3,T4,T5,T6,T7,T8>>)
    [Fact]
    public async Task TapBothAsync_Awaitable_Arity8_Success_InvokesSuccess() {
        ...
        var success = 0;
        await awaitable.TapBothAsync((_, _, _, _, _, _, _, _) => { success++; return Task.CompletedTask; }, _ => Task.CompletedTask);
        Assert.Equal(1, success);
    }
    ...
    public async Task TapBothAsync_Awaitable_Arity8_Success_DoesNotInvokeError() {
        var awaitable = Task.FromResult(Result.Success(1, 2, 3, 4, 5, 6, 7, 8));
        var error = 0;
        await awaitable.TapBothAsync((_, _, _, _, _, _, _, _) => Task.CompletedTask, _ => { error++; return Task.CompletedTask; });
        Assert.Equal(0, error);
    }
