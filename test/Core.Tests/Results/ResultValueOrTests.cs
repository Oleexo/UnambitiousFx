...
public class ResultValueOrTests
{
    ...
    public void ValueOr_Factory_NotInvoked_OnSuccess()
    {
        ...
        var called = false;
        int Fallback() { called = true; return 99; }
    ...
    public void ValueOr_Factory_Invoked_OnFailure()
    {
        ...
        var called = false;
        int Fallback() { called = true; return 77; }
        var v = r.ValueOr(Fallback);
        Assert.True(called);
        Assert.Equal(77, v);
    }
    ...
    {
        Task<Result<int>> task = Task.FromResult(Result.Failure<int>(new Exception()));
    ...
    {
        Task<Result<int>> task = Task.FromResult(Result.Success(11));
