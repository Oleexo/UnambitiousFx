...
public sealed class OneOf7Tests
{
    ...
    public void FromFirst_ShouldSetIsFirst() {
        var result = OneOf<int, string, bool, double, decimal, long, char>.FromFirst(42);
    ...
    public void FromSecond_ShouldSetIsSecond() {
        var result = OneOf<int, string, bool, double, decimal, long, char>.FromSecond("hello");
    ...
    public void FromThird_ShouldSetIsThird() {
        var result = OneOf<int, string, bool, double, decimal, long, char>.FromThird(true);
        Assert.False(result.IsFirst);
        Assert.False(result.IsSecond);
    ...
    public void FromFourth_ShouldSetIsFourth() {
        var result = OneOf<int, string, bool, double, decimal, long, char>.FromFourth(3.14);
        Assert.False(result.IsFirst);
        Assert.False(result.IsSecond);
        Assert.False(result.IsThird);
    ...
    public void FromFifth_ShouldSetIsFifth() {
        var result = OneOf<int, string, bool, double, decimal, long, char>.FromFifth(99.99m);
        Assert.False(result.IsFirst);
        Assert.False(result.IsSecond);
        Assert.False(result.IsThird);
        Assert.False(result.IsFourth);
    ...
    public void FromSixth_ShouldSetIsSixth() {
        var result = OneOf<int, string, bool, double, decimal, long, char>.FromSixth(1000L);
        Assert.False(result.IsFirst);
        Assert.False(result.IsSecond);
        Assert.False(result.IsThird);
        Assert.False(result.IsFourth);
    ...
    public void FromSeventh_ShouldSetIsSeventh() {
        var result = OneOf<int, string, bool, double, decimal, long, char>.FromSeventh('x');
        Assert.False(result.IsFirst);
        Assert.False(result.IsSecond);
        Assert.False(result.IsThird);
        Assert.False(result.IsFourth);
    ...
    public void FromFirst_ShouldStoreValue(int value) {
        var result = OneOf<int, string, bool, double, decimal, long, char>.FromFirst(value);
    ...
    public void FromSecond_ShouldStoreValue(string value) {
        var result = OneOf<int, string, bool, double, decimal, long, char>.FromSecond(value);
    ...
    public void ImplicitConversion_FromSecond_ShouldWork() {
        OneOf<int, string, bool, double, decimal, long, char> result = "hello";
        Assert.True(result.IsSecond);
    ...
    public void ImplicitConversion_FromThird_ShouldWork() {
        OneOf<int, string, bool, double, decimal, long, char> result = true;
        Assert.True(result.IsThird);
    ...
    public void ImplicitConversion_FromFourth_ShouldWork() {
        OneOf<int, string, bool, double, decimal, long, char> result = 3.14;
        Assert.True(result.IsFourth);
    ...
    public void ImplicitConversion_FromFifth_ShouldWork() {
        OneOf<int, string, bool, double, decimal, long, char> result = 99.99m;
        Assert.True(result.IsFifth);
    ...
    public void ImplicitConversion_FromSixth_ShouldWork() {
        OneOf<int, string, bool, double, decimal, long, char> result = 1000L;
        Assert.True(result.IsSixth);
    ...
    public void ImplicitConversion_FromSeventh_ShouldWork() {
        OneOf<int, string, bool, double, decimal, long, char> result = 'x';
        Assert.True(result.IsSeventh);
