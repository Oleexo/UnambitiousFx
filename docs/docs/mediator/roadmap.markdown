...
| Item                                   | Status | Notes                                                        |
|----------------------------------------|--------|--------------------------------------------------------------|
| Outbox pattern improvements            | ✅      | Retry logic, dead-letter queue, batch processing (in-memory) |
| Request pipeline behaviors enhancement | ✅      | Typed behaviors & conditional execution implemented          |
